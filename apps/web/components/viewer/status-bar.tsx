      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-40">
            <DropdownMenuItem onClick={handleOpenInV0} disabled={!selectedFile}>
              <svg
            ...
            <DropdownMenuItem onClick={handleOpenInChatGPT} disabled={!selectedFile}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-3.5 w-3.5 mr-2">
                <path
            ...
            <DropdownMenuItem onClick={handleOpenInClaude} disabled={!selectedFile}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-3.5 w-3.5 mr-2">
                <path
            ...
            <DropdownMenuItem onClick={handleOpenInScira} disabled={!selectedFile}>
              <svg
                width="910"
                height="934"
                viewBox="0 0 910 934"
        ...
        {/* AI Buttons - Hidden on mobile, visible on desktop */}
        <Button
          variant="ghost"
          size="sm"
        ...
        >
          ...
          <span className="hidden md:inline">v0</span>
        </Button>
        ...
        >
          <svg strokeLinejoin="round" viewBox="0 0 22 16" className="h-3.5 w-3.5">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
